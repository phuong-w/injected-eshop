...
//        $status=$user->fill($data)->save();
        $status = DB::statement("UPDATE users SET name ='" . $data['name'] . "', role ='" . $data['role'] . "'" . " WHERE id =" . $id);

//        $status = DB::statement("UPDATE users SET name = ? role = ? WHERE id = ?", [$data['name'], $data['role'], $id]);
